    ...
    return ( 
        ...
        <div className="container border-top mt-5" >
            ...
            <div className="mt-5  text-muted" style={{fontSize:"14px"}}>
                ...
                <p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets once KYC is done through a SEBI registered intermedia (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermedi subscribing to an IPO, there is no need to issue a cheque Please write the Bank account number and sign the IPO application form to authorize your of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyon others. If you find anyone claiming to be part of Zerodha and offering such services, please create a ticket here.
                </p>
            </div>
        </div>  
        </footer>
