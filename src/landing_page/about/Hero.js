    ...
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top text-muted " style={{ lineHeight:      "1.8", fontSize:"1.2em"}}>
           ...
           <div className="col-6 p-5">
                ...
                <p>
                    <a href="" style={{ textDecoration: "none"}}>Rainmatter</a>, our fiach fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>

                <p>And yet, we are always up to something new everyd Catch up on the latest updates on our blog or s the media is saying about us.</p>
           </div>
      </div>
    </div>
  );
