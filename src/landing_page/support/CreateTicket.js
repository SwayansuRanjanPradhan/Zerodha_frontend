    ...
    <div className="container">
      <div className="row p-4 mt-5 mb-5">
          ...
          <div className="col-4 p-5 mt-2 mb-2">
           ...
           <div className="col-4 p-5 mt-2 mb-2">
           <h4 className=""><i class="fa-solid fa-user" aria-hidden="true"></i>Your Zerodha Account</h4>
           ...
           <div className="col-4 p-5 mt-2 mb-2">
           <h4 className=""><i class="fa-sharp-duotone fa-solid fa-chart-column" aria-hidden="true"></i>Your Zerodha Account</h4>
               ...
               <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>GIT</a><br />
           </div>
           <div className="col-4 p-5 mt-2 mb-2">
           <h4 className=""><i class="fa-solid fa-sack-dollar" aria-hidden="true"></i>Funds</h4>
           ...
           <div className="col-4 p-5 mt-2 mb-2">
           <h4 className=""><i class="fa-sharp-duotone fa-solid fa-circle-notch" aria-hidden="true"></i>Console</h4>
           ...
           <div className="col-4 p-5 mt-2 mb-2">
           <h4 className=""><i class="fa-sharp fa-regular fa-circle" aria-hidden="true"></i>Coin</h4>
                ...
                <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Buying and selling th</a><br />
